...
const Calendar = () => {
  ...
  const handlePublishToSocial = (contentData?: any) => {
    setPublishingContent(contentData || null);
  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3 w-full sm:w-auto">
          ...
          <button 
            ...
            className="bg-warm-blue text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-medium hover:bg-warm-blue/90 transition-colors duration-200 flex items-center space-x-2 shadow-soft text-sm sm:text-base"
          >
            <Plus className="w-4 h-4" />
      ...
      <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <ContentCard
          ...
          onPublishToSocial={() => handlePublishToSocial({
            title: "Blog Post Draft",
            description: "Thought Leadership content ready for social media promotion"
          })}
        />
        <ContentCard
          ...
          onPublishToSocial={() => handlePublishToSocial({
            title: "Social Media Series",
            description: "Community Building content series"
          })}
        />
        <ContentCard
          ...
          onPublishToSocial={() => handlePublishToSocial({
            title: "Newsletter Template",
            description: "Product Education newsletter content"
          })}
        />
      </div>
      </div>
      ...
      <SocialPublisher
        ...
        initialContent={publishingContent}
      />
    </>
  );
};
