        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-neutral-600">
              You can now sign in to your account and start using ContentFlow.
            </p>
            <Link
              to="/login"
              className="mt-4 inline-block bg-sage text-white py-3 px-6 rounded-xl font-medium hover:bg-sage/90 transition-colors duration-200"
            >
